        ...
        <div>
            {authenticated ? (<div className="mark-attendance-container">
                ...
                <div className="d-flex justify-content-center">
                    <Link
                        to="/viewattendance"
                        className="simple-link mt-2"
                        style={{ fontSize: '1.3rem', fontWeight: 'bold', color: '#245ba8',}}
                    >
                        <strong>Go to View Attendance</strong>
                    </Link>
                </div>

                <form className="mark-attendance-form mt-4">
